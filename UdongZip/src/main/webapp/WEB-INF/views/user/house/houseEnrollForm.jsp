                ...
                <table class="info-table">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <input type="hidden" name="manageInfo" value=" ">
                        </td>
                    </tr>
                    <tr>
                        <th style="width: 200px; height: 80px;">입주가능일</th>
                        <td colspan="3">
                            <div class="input-group">
                                <input type="date" id="moveinDate" name="moveinDate" class="input short-input" required>
                            </div>
